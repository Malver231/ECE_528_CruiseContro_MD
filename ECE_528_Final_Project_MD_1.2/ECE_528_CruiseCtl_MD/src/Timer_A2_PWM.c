...
void Timer_A2_PWM_Init(uint16_t period_constant, uint16_t duty_cycle_1, uint16_t duty_cycle_2)
{
  ...
  //  TIMER_A2->CCR[0] = period_constant; // period_constant=0xFFFF-1

    // Configure the Timer A2 expansion register to divide the clock frequency by 6
   ...
   // TIMER_A2->CCR[1] = duty_cycle_1;
    ...
    // Set capture mode CAP=1
    TIMER_A2->CCTL[2] = 0xC9F0; //|=
